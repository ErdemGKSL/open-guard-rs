...
pub fn build_systems_step(
    ...
    for module in ModuleType::iter() {
        ...
        let desc = match module {
            ...
            ModuleType::ChannelPermissionProtection => l10n.t("config-channel-permission-protection-desc", None),
            ModuleType::RoleProtection => l10n.t("config-role-protection-desc", None),
            ModuleType::RolePermissionProtection => l10n.t("config-role-permission-protection-desc", None),
            ModuleType::MemberPermissionProtection => l10n.t("config-member-permission-protection-desc", None),
        ...
        options.push(
            serenity::CreateSelectMenuOption::new(label, format!("{:?}", module))
                .description(desc)
        );
    }
    ...
    (
        format!("{}\n{}", l10n.t("setup-step1-title", None), l10n.t("setup-step1-desc", None)),
        vec![serenity::CreateComponent::ActionRow(serenity::CreateActionRow::select_menu(select))],
    )
}
