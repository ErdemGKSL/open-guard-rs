...
pub fn build_ui(
    ...
    let options = vec![
        ...
        serenity::CreateSelectMenuOption::new(l10n.t("setup-log-type-membership", None), "membership")
    ...
    let next_button = serenity::CreateButton::new(format!("setup_module_next_{}_Logging", setup_id))
        .label(l10n.t("setup-next", None))
        .style(serenity::ButtonStyle::Primary);

    (
        format!("{}\n{}", l10n.t("setup-step4-title", Some(&{
